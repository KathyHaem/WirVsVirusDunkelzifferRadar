...
def generate():
    ...
    questionnaire['28743005'] = random_subquestion_boolean(
        questionnaire['49727002'])  # 28743005 == Productive cough (schleimiger Husten)
    ...
    questionnaire['186747009'] = random_subquestion_boolean(
        questionnaire['121973000'])  # 186747009 == Coronavirus infection
    questionnaire['432213005'] = date.today().isoformat() if questionnaire[
        '186747009'] else None  # 432213005 == Date of diagnosis
